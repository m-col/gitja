...
let
  cabalPackageName = "gitserve";
  compiler = "ghc901"; # matching stack.yaml

  # Pin static-haskell-nix version.
  static-haskell-nix =
      fetchTarball https://github.com/nh2/static-haskell-nix/archive/57147ba740363712f589d24dfa005c8c7f6d1056.tar.gz;
  ...
  stack2nix-script = import "${static-haskell-nix}/static-stack2nix-builder/stack2nix-script.nix" {
    ...
    hackageSnapshot = "2021-12-11T00:00:00Z"; # pins e.g. extra-deps without hashes or revisions
  };
